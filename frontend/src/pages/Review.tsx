  ...
  return (
    <div className="space-y-6">
      <section className="glass-panel rounded-[32px] border border-white/70 p-6 shadow-panel">
        <p className="text-sm uppercase tracking-[0.2em] text-pine/70">End of day</p>
        <h2 className="mt-2 text-3xl font-semibold text-ink">Write a short review before you move on.</h2>
        <p className="mt-3 text-sm text-ink/70">The review is stored by date and can be edited later.</p>
      </section>
